...
Preprocess raw csv files into a format suitable for loading into a torch Dataset.
Groups data by object id, groups sequence entries by passband, sorted by time.
Feature engineering and normalization are also performed here.
"""
...
if __name__ == "__main__":
    processor = DatasetProcessor(
        ...
        lightcurves_path=RAW_LIGHTCURVES_FILE,
        output_path=PROCESSED_TRAINING_SET_FILE,
    )
